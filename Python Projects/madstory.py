...
root.title('Mad Story Generator')
Label(root, text= 'Mad Story Generator \n Have Fun!' , font = 'arial 20 bold').pack()
Label(root, text = 'Click Any One :', font = 'roboto').place(x=40, y=80)
...
######buttons   
Button(root, text= 'The Photographer', font ='roboto', command= madstory1, bg = 'ghost white').place(x=60, y=120)
Button(root, text= 'apple and apple', font ='roboto', command = madstory3 , bg = 'ghost white').place(x=70, y=180)
Button(root, text= 'The Butterfly', font ='roboto', command = madstory2, bg = 'ghost white').place(x=80, y=240)
